...
Haemoglobin = st.number_input("Please enter your Haemoglobin Levels (in g/dL)", min_value = 1.00, max_value = 30.00, value = 11.00, step = 1)
FSH = st.number_input("Enter your FSH levels (in mIU/mL): ", value = 12.50, step =1)
AMH = st.number_input("Enter your AMH levels (in ng/mL): ", value = 6.00, step =1)
...
AvgRFollicleSize = st.number_input("Enter your average right follicle size: ", value = 15.00, step =1)
AvgLFollicleSize = st.number_input("Enter your average left follicle size:", value = 15.00, step =1)
